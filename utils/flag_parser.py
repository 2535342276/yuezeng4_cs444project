...
def parse_arguments():
    ...
    parser.add_argument(
        "--max_ep", type=float, default=900000, help="maximum # of episodes"
    )
    ...
    parser.add_argument("--split", default="18/4", help="class split")
    # added
    parser.add_argument('--input_size', type=int, default=224, help='Input size of the model')
    parser.add_argument('--feature_dim', type=int, default=128, help='Dimension of the feature vector')
